  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
          ...
          {MODES.map((m) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex flex-col items-start gap-0.5 rounded-lg px-4 py-3 text-left transition-all",
                  active
        ...
        {mode === "reflection" ? <DailyReflectionMode /> : <FounderStoryMode />}
      </main>
    </div>
  );
}
